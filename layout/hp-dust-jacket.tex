...
\parbox{40mm}{\color{white}\small\raggedright
  Ĉi tiu tradukon estas verkita de J.~Mejer-Norŭud ĉe \url{https://github.com/norwd/hpmor}.

  \bigskip Pro manko de oficalaj tradukoj de la Hari Potr libroj, multe da la nomoj de karakteroj kaj aliaj aferoj kiu ne havas propran vorton en Esperanto, tradukitaj laŭ la angla prononco.
}
\end{bookcoverelement}
